...
INSERT INTO BOOKS (code, description, name) VALUES (300003, 'Java: Como Programar', 'Java: Como Programar');
INSERT INTO BOOKS (code, description, name) VALUES (300004, 'Use a Cabeça! Java é uma experiência completa de aprendizado em programação orientada a objetos (OO) e Java. Projetado de acordo com princípios de aprendizado simples, este livro mostrará de aspectos', 'Use a Cabeça');
